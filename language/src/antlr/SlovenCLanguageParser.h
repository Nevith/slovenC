...
namespace antlr {
    ...
    public:
        ...
        enum {
            ...
            RuleModifier = 4,
            RuleTypeName = 5,
            RulePackageOrTypeName = 6,
            RuleCompilationUnit = 7,
            RuleImportDeclarations = 8,
            RuleImportDeclaration = 9,
            RuleTypeDeclarations = 10,
            RuleSingleTypeImportDeclaration = 11,
            RuleTypeImportOnDemandDeclaration = 12,
            RuleTypeDeclaration = 13,
            RuleClassDeclaration = 14,
            RuleInheritance = 15,
            RuleSuperclass = 16,
            RuleClassTypeList = 17,
            RuleClassBody = 18,
            RuleClassBodyDeclaration = 19,
            RuleFieldDeclaration = 20,
            RuleVariableDeclaratorList = 21,
            RuleVariableDeclarator = 22,
            RuleMethodDeclaration = 23,
            RuleMethodHeader = 24,
            RuleResult = 25,
            RuleMethodDeclarator = 26,
            RuleFormalParameterList = 27,
            RuleFormalParameter = 28,
            RuleMethodBody = 29,
            RuleConstructorDeclaration = 30,
            RuleConstructorDeclarator = 31,
            RuleConstructorBody = 32,
            RuleDestructorDeclaration = 33,
            RuleDestructorDeclarator = 34,
            RuleDestructorBody = 35,
            RuleBlock = 36,
            RuleBlockStatement = 37,
            RuleLocalVariableDeclarationStatement = 38,
            RuleLocalVariableDeclaration = 39,
            RuleStatement = 40,
            RuleBlock_ = 41,
            RuleIfThenStatement = 42,
            RuleBasicForStatement = 43,
            RuleWhileStatement = 44,
            RuleTryCatchesFinally = 45,
            RuleTryBlock = 46,
            RuleReturnStatement = 47,
            RuleThrowStatement = 48,
            RuleBreakStatement = 49,
            RuleContinueStatement = 50,
            RuleEmptyStatement = 51,
            RuleExpressionStatement = 52,
            RuleFinallyBlock = 53,
            RuleCatchClause = 54,
            RuleCatchBlock = 55,
            RuleCondition = 56,
            RuleElseStatement = 57,
            RuleForInit = 58,
            RuleForUpdate = 59,
            RuleExpression = 60,
            RuleCreatorExpression = 61,
            RuleCreatedName = 62,
            RulePrimary = 63,
            RuleExpressionList = 64
        };
