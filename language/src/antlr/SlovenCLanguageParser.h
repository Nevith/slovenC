...
namespace antlr {
    ...
    public:
        ...
        enum {
            ...
            RuleModifier = 4,
            RuleTypeName = 5,
            RuleCompilationUnit = 6,
            RuleImportDeclarations = 7,
            RuleImportDeclaration = 8,
            RuleTypeDeclarations = 9,
            RuleSingleTypeImportDeclaration = 10,
            RuleTypeDeclaration = 11,
            RuleClassDeclaration = 12,
            RuleInheritance = 13,
            RuleSuperclass = 14,
            RuleClassTypeList = 15,
            RuleClassBody = 16,
            RuleClassBodyDeclaration = 17,
            RuleFieldDeclaration = 18,
            RuleVariableDeclaratorList = 19,
            RuleVariableDeclarator = 20,
            RuleMethodDeclaration = 21,
            RuleMethodHeader = 22,
            RuleResult = 23,
            RuleMethodDeclarator = 24,
            RuleFormalParameterList = 25,
            RuleFormalParameter = 26,
            RuleMethodBody = 27,
            RuleConstructorDeclaration = 28,
            RuleConstructorDeclarator = 29,
            RuleConstructorBody = 30,
            RuleBlock = 31,
            RuleBlockStatement = 32,
            RuleLocalVariableDeclarationStatement = 33,
            RuleLocalVariableDeclaration = 34,
            RuleStatement = 35,
            RuleBlock_ = 36,
            RuleIfThenStatement = 37,
            RuleBasicForStatement = 38,
            RuleWhileStatement = 39,
            RuleReturnStatement = 40,
            RuleThrowStatement = 41,
            RuleBreakStatement = 42,
            RuleContinueStatement = 43,
            RuleEmptyStatement = 44,
            RuleExpressionStatement = 45,
            RuleCondition = 46,
            RuleElseStatement = 47,
            RuleForInit = 48,
            RuleForUpdate = 49,
            RuleExpression = 50,
            RulePrimary = 51,
