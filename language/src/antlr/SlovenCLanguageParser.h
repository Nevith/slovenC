...
namespace antlr {
    ...
    public:
        ...
        enum {
            ...
            RuleTypeDeclaration = 10,
            RuleClassDeclaration = 11,
            RuleInheritance = 12,
            RuleSuperclass = 13,
            RuleClassTypeList = 14,
            RuleClassBody = 15,
            RuleClassBodyDeclaration = 16,
            RuleFieldDeclaration = 17,
            RuleFieldDeclarator = 18,
            RuleVariableDeclarator = 19,
            RuleMethodDeclaration = 20,
            RuleMethodHeader = 21,
            RuleResult = 22,
            RuleMethodDeclarator = 23,
            RuleFormalParameterList = 24,
            RuleFormalParameter = 25,
            RuleMethodBody = 26,
            RuleConstructorDeclaration = 27,
            RuleConstructorDeclarator = 28,
            RuleConstructorBody = 29,
            RuleBlock = 30,
            RuleBlockStatement = 31,
            RuleLocalVariableDeclarationStatement = 32,
            RuleLocalVariableDeclaration = 33,
            RuleStatement = 34,
            RuleBlock_ = 35,
            RuleIfThenStatement = 36,
            RuleBasicForStatement = 37,
            RuleWhileStatement = 38,
            RuleReturnStatement = 39,
            RuleThrowStatement = 40,
            RuleBreakStatement = 41,
            RuleContinueStatement = 42,
            RuleEmptyStatement = 43,
            RuleExpressionStatement = 44,
            RuleCondition = 45,
            RuleElseStatement = 46,
            RuleForUpdate = 47,
            RuleExpression = 48,
            RulePrimary = 49,
