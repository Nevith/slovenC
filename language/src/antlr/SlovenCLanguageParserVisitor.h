...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitLiteralFloatingPoint(SlovenCLanguageParser::LiteralFloatingPointContext *context) = 0;
    ...
    virtual antlrcpp::Any visitPackageOrTypeNameUnqual(SlovenCLanguageParser::PackageOrTypeNameUnqualContext *context) = 0;

    virtual antlrcpp::Any visitPackageOrTypeNameQual(SlovenCLanguageParser::PackageOrTypeNameQualContext *context) = 0;
    ...
    virtual antlrcpp::Any visitTypeImportOnDemandDeclaration(SlovenCLanguageParser::TypeImportOnDemandDeclarationContext *context) = 0;

    virtual antlrcpp::Any visitTypeDeclaration(SlovenCLanguageParser::TypeDeclarationContext *context) = 0;

    virtual antlrcpp::Any visitNormalClassDeclaration(SlovenCLanguageParser::NormalClassDeclarationContext *context) = 0;
    ...
    virtual antlrcpp::Any visitClassBodyDeclaration(SlovenCLanguageParser::ClassBodyDeclarationContext *context) = 0;
    ...
    virtual antlrcpp::Any visitConstructorDeclaration(SlovenCLanguageParser::ConstructorDeclarationContext *context) = 0;

    virtual antlrcpp::Any visitConstructorDeclarator(SlovenCLanguageParser::ConstructorDeclaratorContext *context) = 0;

    virtual antlrcpp::Any visitConstructorBody(SlovenCLanguageParser::ConstructorBodyContext *context) = 0;

    virtual antlrcpp::Any visitDestructorDeclaration(SlovenCLanguageParser::DestructorDeclarationContext *context) = 0;

    virtual antlrcpp::Any visitDestructorDeclarator(SlovenCLanguageParser::DestructorDeclaratorContext *context) = 0;
    ...
    virtual antlrcpp::Any visitLocalVariableDeclarationStatement(SlovenCLanguageParser::LocalVariableDeclarationStatementContext *context) = 0;

    virtual antlrcpp::Any visitLocalVariableDeclaration(SlovenCLanguageParser::LocalVariableDeclarationContext *context) = 0;
    ...
    virtual antlrcpp::Any visitDottedThisCallExpression(SlovenCLanguageParser::DottedThisCallExpressionContext *context) = 0;

    virtual antlrcpp::Any visitInstanceofExpression(SlovenCLanguageParser::InstanceofExpressionContext *context) = 0;
    ...
    virtual antlrcpp::Any visitMultiplicativeExpression(SlovenCLanguageParser::MultiplicativeExpressionContext *context) = 0;
