 ...
 */
    ...
    public:
        ...
        virtual void enterPackageOrTypeNameUnqual(SlovenCLanguageParser::PackageOrTypeNameUnqualContext *ctx) = 0;

        virtual void exitPackageOrTypeNameUnqual(SlovenCLanguageParser::PackageOrTypeNameUnqualContext *ctx) = 0;

        virtual void enterPackageOrTypeNameQual(SlovenCLanguageParser::PackageOrTypeNameQualContext *ctx) = 0;

        virtual void exitPackageOrTypeNameQual(SlovenCLanguageParser::PackageOrTypeNameQualContext *ctx) = 0;
        ...
        virtual void
        enterSingleTypeImportDeclaration(SlovenCLanguageParser::SingleTypeImportDeclarationContext *ctx) = 0;

        virtual void
        exitSingleTypeImportDeclaration(SlovenCLanguageParser::SingleTypeImportDeclarationContext *ctx) = 0;

        virtual void
        enterTypeImportOnDemandDeclaration(SlovenCLanguageParser::TypeImportOnDemandDeclarationContext *ctx) = 0;

        virtual void
        exitTypeImportOnDemandDeclaration(SlovenCLanguageParser::TypeImportOnDemandDeclarationContext *ctx) = 0;
        ...
        virtual void enterDestructorDeclaration(SlovenCLanguageParser::DestructorDeclarationContext *ctx) = 0;

        virtual void exitDestructorDeclaration(SlovenCLanguageParser::DestructorDeclarationContext *ctx) = 0;

        virtual void enterDestructorDeclarator(SlovenCLanguageParser::DestructorDeclaratorContext *ctx) = 0;

        virtual void exitDestructorDeclarator(SlovenCLanguageParser::DestructorDeclaratorContext *ctx) = 0;

        virtual void enterDestructorBody(SlovenCLanguageParser::DestructorBodyContext *ctx) = 0;

        virtual void exitDestructorBody(SlovenCLanguageParser::DestructorBodyContext *ctx) = 0;
        ...
        virtual void enterLocalVariableDeclarationStatement(
                SlovenCLanguageParser::LocalVariableDeclarationStatementContext *ctx) = 0;

        virtual void
        exitLocalVariableDeclarationStatement(SlovenCLanguageParser::LocalVariableDeclarationStatementContext *ctx) = 0;
        ...
        virtual void enterTryCatchesFinally(SlovenCLanguageParser::TryCatchesFinallyContext *ctx) = 0;

        virtual void exitTryCatchesFinally(SlovenCLanguageParser::TryCatchesFinallyContext *ctx) = 0;

        virtual void enterTryBlock(SlovenCLanguageParser::TryBlockContext *ctx) = 0;

        virtual void exitTryBlock(SlovenCLanguageParser::TryBlockContext *ctx) = 0;
        ...
        virtual void enterFinallyBlock(SlovenCLanguageParser::FinallyBlockContext *ctx) = 0;

        virtual void exitFinallyBlock(SlovenCLanguageParser::FinallyBlockContext *ctx) = 0;

        virtual void enterCatchClause(SlovenCLanguageParser::CatchClauseContext *ctx) = 0;

        virtual void exitCatchClause(SlovenCLanguageParser::CatchClauseContext *ctx) = 0;

        virtual void enterCatchBlock(SlovenCLanguageParser::CatchBlockContext *ctx) = 0;

        virtual void exitCatchBlock(SlovenCLanguageParser::CatchBlockContext *ctx) = 0;
        ...
        virtual void enterForInit(SlovenCLanguageParser::ForInitContext *ctx) = 0;

        virtual void exitForInit(SlovenCLanguageParser::ForInitContext *ctx) = 0;
        ...
        virtual void
        enterPostIncrementDecrementExpression(SlovenCLanguageParser::PostIncrementDecrementExpressionContext *ctx) = 0;

        virtual void
        exitPostIncrementDecrementExpression(SlovenCLanguageParser::PostIncrementDecrementExpressionContext *ctx) = 0;
        ...
        virtual void enterDottedThisCallExpression(SlovenCLanguageParser::DottedThisCallExpressionContext *ctx) = 0;

        virtual void exitDottedThisCallExpression(SlovenCLanguageParser::DottedThisCallExpressionContext *ctx) = 0;

        virtual void enterInstanceofExpression(SlovenCLanguageParser::InstanceofExpressionContext *ctx) = 0;

        virtual void exitInstanceofExpression(SlovenCLanguageParser::InstanceofExpressionContext *ctx) = 0;
        ...
        virtual void
        enterPreIncrementDecrementExpression(SlovenCLanguageParser::PreIncrementDecrementExpressionContext *ctx) = 0;

        virtual void
        exitPreIncrementDecrementExpression(SlovenCLanguageParser::PreIncrementDecrementExpressionContext *ctx) = 0;
        ...
        virtual void
        enterDottedConstructorCallExpression(SlovenCLanguageParser::DottedConstructorCallExpressionContext *ctx) = 0;

        virtual void
        exitDottedConstructorCallExpression(SlovenCLanguageParser::DottedConstructorCallExpressionContext *ctx) = 0;
        ...
        virtual void enterCreatedName(SlovenCLanguageParser::CreatedNameContext *ctx) = 0;

        virtual void exitCreatedName(SlovenCLanguageParser::CreatedNameContext *ctx) = 0;
        ...
        virtual void enterPrimaryTypeClass(SlovenCLanguageParser::PrimaryTypeClassContext *ctx) = 0;

        virtual void exitPrimaryTypeClass(SlovenCLanguageParser::PrimaryTypeClassContext *ctx) = 0;

        virtual void enterPrimaryVoidClass(SlovenCLanguageParser::PrimaryVoidClassContext *ctx) = 0;

        virtual void exitPrimaryVoidClass(SlovenCLanguageParser::PrimaryVoidClassContext *ctx) = 0;
