...
public:
  ...
  virtual void enterTypeImportOnDemandDeclaration(SlovenCLanguageParser::TypeImportOnDemandDeclarationContext *ctx) = 0;
  virtual void exitTypeImportOnDemandDeclaration(SlovenCLanguageParser::TypeImportOnDemandDeclarationContext *ctx) = 0;
